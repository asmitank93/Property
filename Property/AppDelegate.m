...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    dbpath=[st_path stringByAppendingPathComponent:@"actor.fgh"];
    NSLog(@"%@",dbpath);
    if (![[NSFileManager defaultManager]fileExistsAtPath:dbpath])
    {
        sqlite3 *dbsql=nil;
        NSArray *arr_query=[NSArray arrayWithObjects:@"create table actor(a_id integer primary key autoincrement,a_nm varchar(250),a_img varchar(250))", nil];
